...
//{one variable} = you can use this as a function
...
var tracking = __webpack_require__(28);
...
var _reducerUsers = __webpack_require__(59);

var _reducerUsers2 = _interopRequireDefault(_reducerUsers);

var _reducerActiveUser = __webpack_require__(60);

var _reducerActiveUser2 = _interopRequireDefault(_reducerActiveUser);

var _reducerAddUser = __webpack_require__(65);

var _reducerAddUser2 = _interopRequireDefault(_reducerAddUser);
...
var allReducer = (0, _redux.combineReducers)({
  ...
  addUser: _reducerAddUser2.default
});
...
var _userDetail = __webpack_require__(64);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function addButton() {
      var newPeople = document.getElementById("add-cool-people").value;
      this.setState({
        input: newPeople
      });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { id: 'add-cool-people', placeholder: 'Add Cool People' }),
        _react2.default.createElement(
          'button',
          { id: 'add-button', onClick: this.addButton },
          'Add people'
        ),
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ addUser: _index.addUser }, dispatch);
}
...
var selectUser = exports.selectUser = function selectUser(user) {
  ...
  return {
    type: "USER_SELECTED",
    payload: user //this bit is action
  };
